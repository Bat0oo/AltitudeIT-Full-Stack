...
namespace AltitudeIT_Full_Stack.Services.Interfaces
{
    public interface IProductService
    {
        ...
        Task<ProductResponseDTO> CreateProductAsync(ProductCreateRequestDTO request);
        Task<ProductResponseDTO?> UpdateProductAsync(int id, ProductUpdateRequestDTO request);
